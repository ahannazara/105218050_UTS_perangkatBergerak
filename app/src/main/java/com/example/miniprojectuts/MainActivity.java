...
public class MainActivity extends AppCompatActivity implements RVinterface{
    ...
    private void fillmaillist() {
        ...
        maillist p2 = new maillist(3,"Entong","But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness.",  "05","mei","2020","", "the truth of happiness");
        maillist p3 = new maillist(4,"Budi","At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, ",  "06","mei","2020","", "forsee the pain");
        maillist p4 = new maillist(5,"Teguh","saya sudah culik si farhun On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue",  "06","mei","2020","","deserunt mollitia");
        maillist p5 = new maillist(6,"Monika","are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue",  "06","mei","2020","", "bound to bound");
        maillist p6 = new maillist(7,"zidan","On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue",  "06","mei","2020","", "random title");
        maillist p7 = new maillist(8,"Rian","quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi",  "06","mei","2020","", "another random title");

        listmail.addAll(Arrays.asList(new maillist[]{p0, p1, p2, p3, p4, p5, p6, p7}));
    }
